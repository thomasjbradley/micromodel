...
abstract class MicroModel implements \ArrayAccess, \Iterator, \JsonSerializable {
  ...
  public function __construct (\Silex\Application $app, $clauses = null) {
    ...
    /**
     * @deprecated registerFields() deprecated since version 1.1.1, to be removed in 2.0.0
     *             See {@link defineSchema()}
     */
   ...
   */
  public function find ($order = null, $where = array()) {
  ...
  /**
   * @deprecated Deprecated since version 1.1.1, to be removed in 2.0.0
   *             Use {@link defineField()} instead
   */
  public function register ($field, $type = 'text', $options = array()) {
    $this->defineField($field, $type, $options);
  }

  /**
   * @deprecated Deprecated since version 1.1.1, to be removed in 2.0.0
   *             Use {@link find()} instead
   */
  public function all ($order = null, $where = array()) {
    return $this->find($order, $where);
  }
}
